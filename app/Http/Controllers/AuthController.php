...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        return redirect()->route('login')->with('success', 'تم تقديم طلب إنشاء الحساب بنجاح! 🚀 حسابك حالياً قيد المراجعة والاعتماد من قِبل إدارة مدرسة الكتاب المقدس. سيتم تفعيل حسابك وإخطارك عبر البريد الإلكتروني فور الموافقة.');
    }
        ...
        if (Auth::attempt($credentials, $request->boolean('remember'))) {
            ...
            if (!$user->is_active) {
                ...
                return back()->withErrors([
                    'email' => '⏳ حسابك قيد المراجعة والاعتماد من قِبل إدارة مدرسة الكتاب المقدس ولم يتم تفعيله بعد. سيتم تفعيل حسابك وإخطارك عبر البريد الإلكتروني فور الموافقة.',
                ])->onlyInput('email');
            }
