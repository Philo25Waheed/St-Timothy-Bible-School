...
class AccountApprovedMail extends Mailable
{
    ...
    {
        return $this->subject('🎉 تم اعتماد وتفعيل حسابك في مدرسة القديس تيموثاوس للكتاب المقدس')
                    ->html('
                        <div style="direction: rtl; text-align: right; font-family: Cairo, sans-serif; padding: 20px; background-color: #f8fafc; border-radius: 8px;">
                            ...
                            <p style="font-size: 16px; color: #334155;">سعداء بإعلامك أنه قد تم <strong>اعتماد وتفعيل حسابك بنجاح</strong> من قِبل إدارة مدرسة القديس تيموثاوس للكتاب المقدس.</p>
